...
--
-- Servidor: localhost
-- Tiempo de generación: 26-04-2026 a las 02:07:57
...
INSERT INTO `factura` (`idFactura`, `idTarjeta`, `subtotal`, `itbms`, `total`) VALUES
(1, 1, 109.9000, 7.6930, 117.5930),
(3, 3, 25.0000, 1.7500, 26.7500),
(4, 3, 49.5000, 3.4650, 52.9650),
(5, 3, 109.9000, 7.6930, 117.5930),
(6, 2, 58.8000, 4.1160, 62.9160);
...
INSERT INTO `factura_detalle` (`idFacDet`, `idFactura`, `idProducto`, `cantidad`, `precio_unitario`) VALUES
(1, 5, 7701010100027, 1, 109.9000),
(2, 6, 7702030100011, 2, 29.4000);
...
INSERT INTO `tarjeta` (`idTarjeta`, `tipo`, `digitos`, `fechaVence`, `codSeguridad`, `saldo`, `saldoMaximo`) VALUES
(1, 'Débito', '4123456789012345', '2028-05-01', '382', 529.32, 2000.00),
(2, 'Crédito', '5234567890123456', '2027-10-01', '194', 487.08, 1500.00),
(3, 'Débito', '4556789012345678', '2029-02-01', '627', 783.45, 3000.00);
...
--
ALTER TABLE `factura_detalle`
  MODIFY `idFacDet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
